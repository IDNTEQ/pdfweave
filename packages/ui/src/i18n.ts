import type { Lang, Dict } from '@pdfweave/common';
...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'designer.sampleData': 'Sample data',
  'designer.sampleData.readOnly': 'Read only',
  'designer.sampleData.valid': '✓ Valid',
  'designer.sampleData.invalid': '✗ Invalid',
  'designer.sampleData.errorLine': 'Line {n}: {message}',
