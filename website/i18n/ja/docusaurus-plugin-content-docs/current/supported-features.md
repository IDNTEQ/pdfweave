...
独立した[`@pdfweave/imposition`](/imposition)パッケージは、現在次の片面n-up出力をサポートしています。

- A2、A3、A4、A5、A6、Letter、Legal、およびカスタム物理シートサイズ
- 行、列、余白、溝、配置順、位置合わせ、contain/cover/等倍、クリッピング、自動90度回転
- 元ページの選択、重複選択、部数、丁合または非丁合の順序
- MediaBox、CropBox、TrimBox、BleedBox、ArtBoxの選択と明示的なフォールバック警告
- 検査可能な配置プランと設定可能な処理上限

両面面付け、中綴じ折丁、断裁・見当マーク、クリープ、カラー・プリフライト制御は計画中であり、現在は未対応です。
